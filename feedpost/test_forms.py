...
class TestRegisterForm(TestCase):
    ...
    def test_fields_are_explicit_in_form_metaclass(self):
        form = RegisterForm()
        self.assertEqual(form.Meta.fields, ['is_guest', 'is_parent', 'username', 'email'])
...
class TestParentForm(TestCase):
    ...
    def test_postform_title_is_required(self):
        ...
        self.assertEqual(form.errors['parent_name'][0], 'This field is required.')
...
class TestChildForm(TestCase):
    ...
    def test_postform_title_is_required(self):
        ...
        self.assertEqual(form.errors['child_name'][0], 'This field is required.')

    def test_profile_image_field_is_not_required(self):
        form = ChildForm({
            'child_name': 'Theo Porras',
            'birthdate': '03/11/2021'
            })
...
class TestGuestForm(TestCase):
    ...
    def test_guest_guest_name_is_required(self):
        ...
        self.assertEqual(form.errors['guest_name'][0], 'This field is required.')
